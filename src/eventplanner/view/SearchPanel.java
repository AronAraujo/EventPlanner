...
public class SearchPanel extends JDialog {
    ...
    private void buildUI() {
        ...
        JLabel title = new JLabel("Buscar Eventos");
    ...
    private void doSearch() {
        ...
        if (q.isEmpty()) { resultsPanel.revalidate(); resultsPanel.repaint(); return; }

        List<Event> results = controller.search(q);
        if (results.isEmpty()) {
            JLabel none = new JLabel("Nenhum resultado encontrado.");
            ...
            for (Event e : results) {
                ...
                JLabel when = new JLabel(e.getDate().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) + " às " +
